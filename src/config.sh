...
export CFLAGS='-O3 -mcpu=cortex-a8 -mfpu=neon -ftree-vectorize -mfloat-abi=softfp -ffast-math -fsingle-precision-constant -funroll-loops -DARM_CORE -DFINAL_VERSION -Wdisabled-optimization'
